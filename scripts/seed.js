...
const productsData = [
  ...
  },
  {
    ...
    sizes: ["M", "L", "XL"],
    image: "https://image2url.com/images/1763098828408-234e33cf-97db-4d57-aa87-489d271071fb.jpg",
    stock: 15
  },
  {
    customId: 3,
...
const seedDB = async () => {
  try {
    ...
    console.log("Connected successfully. Clearing existing products...");
    await Product.deleteMany({});
    console.log("Existing products cleared. Inserting new products...");
    const products = await Product.insertMany(productsData);
    console.log(`Seeding complete. Successfully inserted ${products.length} products!`);
    process.exit(0);
  } catch (error) {
